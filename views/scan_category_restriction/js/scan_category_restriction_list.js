(function ($) {
    ...
    function initData(dataArray) {
        ...
        $.each(dataArray, function (i, object) {
            ...
            r += '<div class="td inlineText">' + object.scanLimit + '</div>';
    ...
    function initDataList() {
        ...
        $.ajax({
            type: "POST",
            url: API_URL + '/scan_category_restriction/cslist',
    ...
    $('body').on('click', '.deleteListItem', function () {
        ...
        $.ajax({
            type: "POST",
            url: API_URL + '/scan_category_restriction/delete',
            data: JSON.stringify({
                id: id
            }),
            contentType: "application/json; charset=utf-8",
    ...
    $('#getSearchResult').click(function () {
        ...
        var dataString = {
            filterCatName: $('#filterCatName').val(),
        }

        if ($('#filterCatName').val() === "") {
