...
<div class="content-wrapper">
	<h1 class="pageMainTitle">Scan Trend Model <strong style="font-size: 12px;font-weight:normal">(Report will be based on Jan - Dec of Calender year.)</strong></h1>

  <section class="content-header clfix">
    <div class="topLeftFilters">
        
    <a href="<?php echo APP_URL; ?>/report/ByDate_scanTrendModule" class="btn btn-success" style="float:left;"><i class="mdi mdi-search"></i> Switch To Scan Model By Month</a>
    <br><br><br>
