...
$('#plant').change(function() {
    ...
    function searchScanTrendModule()
    {
        ...
        $.ajax({
            type: "POST",
            url: API_URL + '/report/ChartscanTrendModule',
            data: JSON.stringify(dataString),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            cache: false,
        ...
        */
            ...
            success: function(response) {
               ...
               num=response.num;
			   point=response.point;
			   yearof = response.startyear+response.endyear;
               if(response.max>0)
               max = response.max;
    ...
    $('#getSearchResult').click(function(){
	 ...
	 $('#getSearchResultwelcome').click(function(){
    ...
    $('#getDownload').click(function(){
        ...
        $.ajax({
            type: "POST",
            url: API_URL + '/report/scanTrendModuleDownload',
            data: JSON.stringify(dataString),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            cache: false,
