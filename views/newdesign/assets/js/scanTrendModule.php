...
<div class="content-wrapper">
	<h1 class="pageMainTitle">Scan Trend Module <strong style="font-size: 12px;font-weight:normal">(Report will be based on APRIL - MARCH of financial year.)</strong></h1>

  <section class="content-header clfix">
    <div class="topLeftFilters">
        
    <a href="<?php echo APP_URL; ?>/report/ByDate_scanTrendModule" class="btn btn-success" style="float:left;"><i class="mdi mdi-search"></i> Switch To Scan Module By Month</a>
    <br><br><br>
...
<?php 
	$moduleScripts[] = VIEW_PATH.'/report/js/scanTrendModule.js';
