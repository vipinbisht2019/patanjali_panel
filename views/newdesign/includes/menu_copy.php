...
<aside id="sidebar-wrapper">
  <div class="sidebar-brand">
    <a href="<?php echo APP_URL; ?>/dashboard"> <!--<img alt="image" src="views/newdesign/assets/img/logo.png" class="header-logo" />--> <span
        class="logo-name" style="font-size:17px;">Paras Admin Panel</span>
    </a>
  </div>
