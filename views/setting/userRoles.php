...
<div class="content-wrapper">
	<h1 class="pageMainTitle">Roles</h1>
...
<!--     <div class="th">Email</div>
		...
		<div class="tbody" id="dataTableResult_new">

    <?php
        foreach($ct as $keyNums => $roleTypes) {
    ?>
    <div class="tr align-items-center">
      <div class="td inlineText"><?php  echo $keyNums; ?></div><div class="td inlineText"><?php  echo $roleTypes; ?></div>
    </div>
    <?php } ?>    
...
<?php  
	$moduleScripts[] = VIEW_PATH.'/setting/js/userRoles.js';
