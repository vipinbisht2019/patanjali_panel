(function($) {
    ...
    function initData(dataArray) {
        ...
        $.each(dataArray, function(i, object) {
            ...
            r += '<div class="td inlineText">' + object.roleName + '</div>';
            ...
            r += '<a href="javascript:;" class="deleteListItem" data-id="' + object.roleId + '"><i class="mdi mdi-delete"></i></a>';
            r += '</div>';
            r += '</div>';
        });
        dataResult.html(r);
